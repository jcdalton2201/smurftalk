...
exports.data = {
    ...
    exports.render = (data) =>`
    <div class='sink'><h1>squid-number</h1>
    <h2>Description</h2> <p>The <code>SquidNumber</code> element is an implementation of a text field as number. This particular element is analagous to an <code>HTMLInputElement</code> with a type of <code>'number'</code>.</p>
...
<td>undefined</td>
    ...
    <h2>Example</h2>
<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">squid-number</span>&gt;</span>Enter number<span class="hljs-tag">&lt;/<span class="hljs-name">squid-number</span>&gt;</span>
</code></pre>
