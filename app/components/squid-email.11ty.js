...
exports.data = {
    ...
    exports.render = (data) =>`
    <div class='sink'><h1>squid-email</h1>
    <h2>Description</h2> <p>The <code>SquidEmail</code> defines a field for an e-mail address.
The input value is automatically validated to ensure it is a properly formatted e-mail address.</p>
...
<td>undefined</td>
    ...
    <h2>Example</h2>
<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">squid-email</span>&gt;</span>Test Email<span class="hljs-tag">&lt;/<span class="hljs-name">squid-email</span>&gt;</span>
</code></pre>

    <hr>
    <div>
    <squid-email>Test Email</squid-email> 
    </div>
    </div>
                    `;
