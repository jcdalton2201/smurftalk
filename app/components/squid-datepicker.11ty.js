...
exports.data = {
    title:"squid-datepicker",
    tags:"components",
    layout:"component_layout.11ty.js"
};
    
    exports.render = (data) =>`
    <div class='sink'><h1>squid-datepicker</h1>
    <h2>Description</h2> <p>The <code>SquidDatepicker</code> component is an version of input with a type of text.<br>
It will use the <a href="../squid-Calendar">SquidCalendar</a> to display a calendar for picking a date.</p>
...
<td>undefined</td>
    ...
    <h2>Example</h2>
<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">squid-datepicker</span> <span class="hljs-attr">required</span> &gt;</span>This input will run validations&lt;/squid-datepicker
</code></pre>
