...
exports.data = {
    title:"squid-input-mask",
    tags:"components",
    layout:"component_layout.11ty.js"
};
    
    exports.render = (data) =>`
    <div class='sink'><h1>squid-input-mask</h1>
    <h2>Description</h2> <p>The <code>SquidInputMask</code> is functionally an <code>SquidInput</code> component with an input mask attached to enforece a particular pattern. This now serves as the base class for <a href="../squid-telephone">SquidTelephone</a>.</p>
...
<td>undefined</td>
    ...
    <h2>Example</h2>
<pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">squid-input-mask</span> <span class="hljs-attr">mask</span>=<span class="hljs-string">&quot;(111) 111-1111&quot;</span>&gt;</span>Telephone Number<span class="hljs-tag">&lt;/<span class="hljs-name">squid-input-mask</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">squid-input-mask</span> <span class="hljs-attr">mask</span>=<span class="hljs-string">&quot;1AAAA11AAAA111111&quot;</span> <span class="hljs-attr">helper</span>=<span class="hljs-string">&quot;Format: 1AAAA11AAAA111111&quot;</span>&gt;</span>Vehicle Identification Number<span class="hljs-tag">&lt;/<span class="hljs-name">squid-input-mask</span>&gt;</span>
</code></pre>
